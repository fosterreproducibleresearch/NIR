"""
How to run:
python ebr.py --output_dir EBR/carcinogenesis --path_kg datasets/carcinogenesis/kb/ontology.owl --path_kge_model datasets/carcinogenesis/embeddings  --device gpu --dataset_dir datasets/carcinogenesis --path_report EBR/carcinogenesis/ebr_results.csv
"""
...
def execute(args):
    ...
    if args.path_kge_model:
        ...
        neural_ontology = NeuralOntology(path_neural_embedding=args.path_kg,
                                         train_if_not_exists=True, training_params={"scoring_technique": "KvsAll", "model": args.kg_model,
...
def get_default_arguments():
    ...
    parser.add_argument("--model", type=str, default="EBR")
